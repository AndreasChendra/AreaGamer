@extends('layouts.app')
@section('title', "{$product[0]->pcategory->name} - AreaGamer")
        ...
        <div class="mt-5 pt-3">
            <div class="card shadow-sm">
                <div class="p-3">
                    ...
                    <a href="/product/type/{{ $product[0]->productType_id }}">{{ $product[0]->ptype->name }}</a><i
                        class="bi bi-caret-right-fill pl-1 pr-1"></i>
                    <a href="/product/category/{{ $product[0]->productCategory_id }}">{{ $product[0]->pcategory->name }}</a>
                </div>
            </div>
